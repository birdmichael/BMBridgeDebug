...
@interface BDDebugViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation BDDebugViewController
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        _tableView.backgroundColor = BDColorFromRGB(0xF8F8F8);
